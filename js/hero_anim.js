...
function createWorld() {
  ...
  //---
  document
    .getElementById('hero_background_anim')
...
function animation() {
  ...
  object_guide.position.x +=
    Math.sin(object_place.position.x) - object_guide.position.x * object_speed;
  object_guide.position.y +=
    Math.cos(object_place.position.y) - object_guide.position.y * object_speed;
...
// let stage = document.getElementById('hero_background_anim');
